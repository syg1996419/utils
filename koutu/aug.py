...
def copysmallobjects(image_dir, label_dir, save_base_dir, small_img_dir,
    ...
    for small_img_dirs in small_img_dir:
        clss = small_img_dirs.split('_')[-1].split('.')[0]
        # print(clss)
    ...
    cv2.imwrite(
        ...
        image)
    # print(save_dir)
    # print(basename(image_dir).replace('.jpg', '_aug_%s.jpg' % str(times)))
    # print(join(save_dir,basename(image_dir).replace('.jpg', '_aug_%s.jpg' % str(times))))
